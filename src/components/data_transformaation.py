...
class DataTransformationConfig:
    artifact_dir = od.path.join(artifact_folder)
    transformed_train_file_path = os.path.join(artifact_dir, 'train.npy')
    transformed_test_file_path = os.path.join(artifact_dir, 'test.pkl')
...
class DataTransformation:
    def __init__(self,feature_store_file_path):
        ...
        self.data_transformatoin_config = DataTransformation()
    ...
    def initate_data_transformation(self):
        ...
        logging.info('Entered initiate data trasformation method of data transformation class')
        ...
        try:
            ...
            preprocessor_path = self.data_transformatoin_config.transformed_object_file_path
